    ...
    <div class="d-flex">
        ...
        <div class="dropdown d-inline-block">
            <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <img class="rounded-circle header-profile-user" src="{{ isset(Auth::user()->avatar) ? Auth::user()->getavatar(Auth::user()->id,Auth::user()->avatar) : asset('/public/assets/images/users/avatar-1.jpg') }}"
                    alt="Header Avatar">
